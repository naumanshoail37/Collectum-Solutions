...
const Slider = () => {
  ...
  return (
    <div className="relative w-full h-[400px] bg-black text-white flex flex-col items-center justify-center overflow-hidden p-4">
      <div className="flex flex-col items-center text-center">
       
        <p className="text-[24px] font-serif w-[1000px] mb-4">{slides[currentSlide].description}</p>
        <div className='flex'>
        <div className='container h-[50px] w-[50px] bg-red-600'><div className='m-3 text-black'><RiDoubleQuotesL size={25} /></div></div>
        <h2 className="text-[20px] font-bold mb-2 mt-[-5px] m-2">{slides[currentSlide].name}</h2>
        </div>
        <div className=" text-[13px] text-red-600 mt-[-25px] pl-[45px]"> {slides[currentSlide].rank}</div>
