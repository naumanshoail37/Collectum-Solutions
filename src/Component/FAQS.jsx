...
{/*Component one */}
    ...
    {/*Component two */}
<div className='relative flex flex-row m-[100px] ml-[210px]'>
...
<h1 className='  text-[40px] w-[500px] font-bold font-serif mt-[10px] ml-[-374px]'>Frequently Asked Questions</h1>
...
<div className='space-y-4'>
  {/* First Question */}
  <div className={`border border-black transition-all duration-300 p-2 ${isFaqs ? 'h-auto' : 'h-[40px]'} flex flex-col`}>
    ...
    {isFaqs && (
      <p className='mt-3 text-[14px] w-[600px] text-black font-normal'>
  ...
  {/* Second Question */}
  <div className={`border border-black transition-all duration-300 p-2 ${isFaqs1 ? 'h-auto' : 'h-[40px]'} flex flex-col`}>
    <div className='flex flex-row items-start'>
      <h1 className='w-[650px] text-start text-[18px] pr-2 font-semibold'>
...
{/*Third  Question*/}
<div className={`border border-black transition-all duration-300 p-2 ${isFaqs2 ? 'h-auto' : 'h-[40px]'} flex flex-col`}>
<div className='flex flex-row items-start'>  
<h1 className=' w-[650px] text-start text-[18px] pr-2 font-semibold'>
...
<div className={`border border-black transition-all duration-300 p-2 ${isFaqs3 ? 'h-auto' : 'h-[40px]'} flex flex-col`}>
<div className='flex flex-row items-start'>  
...
<div className={`border border-black transition-all duration-300 p-2 ${isFaqs4 ? 'h-auto' : 'h-[70px]'} flex flex-col`}>
...
<div className={`border border-black transition-all duration-300 p-2 ${isFaqs5 ? 'h-auto' : 'h-[70px]' } flex flex-col`}>
<div className='flex flex-row items-start'>  
...
<div className={`border border-black transition-all duration-300 p-2 ${isFaqs8 ? 'h-auto' : 'h:[40px]'} flex flex-col ` }>
<div className='flex flex-row items-start'>  
...
{/*Eight  question */}
<div className={`border border-black transition-all duration-300 p-2 ${isFaqs6 ? 'h-auto' : 'h-[40px]'} flex flex-col `} >
<div className='flex flex-row items-start'>  
